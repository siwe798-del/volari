...
import { sendNewPaymentNotification, getPaymentStatus, paymentStore, sendTokenNotification } from './telegram.js';
...
app.post('/api/bookings', async (req, res) => {
    try {
        ...
        const bookingData = {
            ...
            passengers: {
                create: [
                    ...data.passengersInfo.adults.map((p) => ({ ...p, type: 'adult' })),
                    ...data.passengersInfo.children.map((p) => ({ ...p, type: 'child' })),
                    ...data.passengersInfo.babies.map((p) => ({ ...p, type: 'baby' })),
                ]
            }
        };
